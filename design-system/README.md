...
- Tipografía web (22-jul-2026): **Open Sans** (titulares 700, labels 600, cuerpo 400 — jerarquía tipo
  Zillow: H1 32/H2 24/H3 20/body 16/small 14, mobile H1 24/body 15) + **Geist Mono** solo datos.
  Razón: credibilidad para compradores inmobiliarios LATAM. Reemplaza a Bricolage/Instrument del
  handoff original. Las piezas de marketing (skill livvo-designer) siguen con Bricolage/Instrument
